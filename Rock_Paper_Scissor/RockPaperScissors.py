...
class RPSGame(Tk):
    ...
    def create_widgets(self):
        self.canvas2=Canvas(self,width=1300,height=100,bd=2,bg="#000080")
        self.canvas2.pack()
        self.canvas = Canvas(self, width=1300, height=680 ,bd=2 , bg='Navy')
        self.canvas.pack()
        ...
        self.label2=Label(self.canvas2,text="PLAYER:",font=("Papyrus",15,"bold"),fg="white",bg="#000080")
        ...
        self.label2=Label(self.canvas2,text="Computer:",font=("Lucida Handwriting",15,"bold"),fg="white",bg="#000080")
        self.label2.place(x=400,y=70)
        self.l1=Label(self,text="Player",font=("Courier",25,"bold"),fg="white",bg="#000080")
        self.l2=Label(self,text="Computer",font=("Courier",25,"bold"),fg="white",bg="#000080")
        self.l3=Label(self,text="Vs",font=("Courier",40,"bold"),fg="white",bg="#000080")
    ...
    def create_user_images(self, player):
        ...
        if player == 1:
            self.image_on_canvas_user = self.create_image('paperu.png',500, 350)
        elif player == 2:
            self.image_on_canvas_user = self.create_image('rocked.png', 500, 350)
        else:
            self.image_on_canvas_user = self.create_image('scissor.png',500, 350)
        self.canvas.create_image(0, 100,anchor="nw",image=self.image_on_canvas_user)

    def create_comp_images(self, computer):
        if computer == 1:
            self.image_on_canvas_comp = self.create_image('paper.png', 1000, 100)
        elif computer == 2:
            self.image_on_canvas_comp = self.create_image('rock3.png', 1000, 100)
        else:
            self.image_on_canvas_comp = self.create_image('scissorc.png', 1000, 100)
